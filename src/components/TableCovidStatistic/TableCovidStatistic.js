                        ...
                        {(this.state && this.state.data) ?
                            this.state.data.map(row =>
                                (<TableRow key={row.name}>
                                    ...
                                    <TableCell align="right">{this.parseToNewCases(row.newCases)}</TableCell>
                                    <TableCell align="right">{this.parseToNewCases(row.newDeath)}</TableCell>
                                    <TableCell align="right">{this.parseToNewCases(row.newRecovered)}</TableCell>
                                    <TableCell align="right">{this.parseTableValue(row.totalCases)}</TableCell>
                                    <TableCell align="right">{this.parseTableValue(row.totalDeath)}</TableCell>
                                    <TableCell align="right">{this.parseTableValue(row.totalRecovered)}</TableCell>
                                    <TableCell align="right">{this.parseTableValue(row.activeCases)}</TableCell>
                                    <TableCell align="right">{this.parseTableValue(row.seriousCritical)}</TableCell>
                                    <TableCell align="right">{this.parseTableValue(row.population)}</TableCell>
                                    <TableCell align="right">{this.parseTableValue(row.totalCasesPerMln)}</TableCell>
                                    <TableCell align="right">{this.parseTableValue(row.deathsPerMln)}</TableCell>
                                    <TableCell align="right">{this.parseTableValue(row.testsPerMln)}</TableCell>
                                </TableRow>)
                            )
                            : "loading..."}
                    </TableBody>
